...
namespace gdtools {
    ...
    inline XPtrFontFileContext fontfile_context_create(CharacterVector fontfiles) {
        typedef SEXP(*Ptr_fontfile_context_create)(SEXP);
        static Ptr_fontfile_context_create p_fontfile_context_create = NULL;
        if (p_fontfile_context_create == NULL) {
            validateSignature("XPtrFontFileContext(*fontfile_context_create)(CharacterVector)");
            p_fontfile_context_create = (Ptr_fontfile_context_create)R_GetCCallable("gdtools", "gdtools_fontfile_context_create");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
            rcpp_result_gen = p_fontfile_context_create(Rcpp::wrap(fontfiles));
        }
        if (rcpp_result_gen.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (rcpp_result_gen.inherits("try-error"))
            throw Rcpp::exception(as<std::string>(rcpp_result_gen).c_str());
        return Rcpp::as<XPtrFontFileContext >(rcpp_result_gen);
    }

    inline bool fontfile_context_set_font(XPtrFontFileContext cc, double fontsize, bool bold, bool italic, std::string fallback) {
        typedef SEXP(*Ptr_fontfile_context_set_font)(SEXP,SEXP,SEXP,SEXP,SEXP);
        static Ptr_fontfile_context_set_font p_fontfile_context_set_font = NULL;
        if (p_fontfile_context_set_font == NULL) {
            validateSignature("bool(*fontfile_context_set_font)(XPtrFontFileContext,double,bool,bool,std::string)");
            p_fontfile_context_set_font = (Ptr_fontfile_context_set_font)R_GetCCallable("gdtools", "gdtools_fontfile_context_set_font");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
            rcpp_result_gen = p_fontfile_context_set_font(Rcpp::wrap(cc), Rcpp::wrap(fontsize), Rcpp::wrap(bold), Rcpp::wrap(italic), Rcpp::wrap(fallback));
        }
        if (rcpp_result_gen.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (rcpp_result_gen.inherits("try-error"))
    ...
    inline FontMetric fontfile_context_extents(XPtrFontFileContext cc, std::string x) {
        typedef SEXP(*Ptr_fontfile_context_extents)(SEXP,SEXP);
        static Ptr_fontfile_context_extents p_fontfile_context_extents = NULL;
        if (p_fontfile_context_extents == NULL) {
            validateSignature("FontMetric(*fontfile_context_extents)(XPtrFontFileContext,std::string)");
            p_fontfile_context_extents = (Ptr_fontfile_context_extents)R_GetCCallable("gdtools", "gdtools_fontfile_context_extents");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
            rcpp_result_gen = p_fontfile_context_extents(Rcpp::wrap(cc), Rcpp::wrap(x));
        }
        if (rcpp_result_gen.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (rcpp_result_gen.inherits("try-error"))
    ...
    inline XPtrFamiliesContext font_context_create(std::string fontname_, CharacterVector sans_files, CharacterVector serif_files, CharacterVector mono_files) {
        typedef SEXP(*Ptr_font_context_create)(SEXP,SEXP,SEXP,SEXP);
        static Ptr_font_context_create p_font_context_create = NULL;
        if (p_font_context_create == NULL) {
            validateSignature("XPtrFamiliesContext(*font_context_create)(std::string,CharacterVector,CharacterVector,CharacterVector)");
            p_font_context_create = (Ptr_font_context_create)R_GetCCallable("gdtools", "gdtools_font_context_create");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
            rcpp_result_gen = p_font_context_create(Rcpp::wrap(fontname_), Rcpp::wrap(sans_files), Rcpp::wrap(serif_files), Rcpp::wrap(mono_files));
        }
        if (rcpp_result_gen.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (rcpp_result_gen.inherits("try-error"))
            throw Rcpp::exception(as<std::string>(rcpp_result_gen).c_str());
        return Rcpp::as<XPtrFamiliesContext >(rcpp_result_gen);
    }

    inline bool font_context_set_font(XPtrFamiliesContext cc, std::string family, double fontsize, bool bold, bool italic) {
        typedef SEXP(*Ptr_font_context_set_font)(SEXP,SEXP,SEXP,SEXP,SEXP);
        static Ptr_font_context_set_font p_font_context_set_font = NULL;
        if (p_font_context_set_font == NULL) {
            validateSignature("bool(*font_context_set_font)(XPtrFamiliesContext,std::string,double,bool,bool)");
            p_font_context_set_font = (Ptr_font_context_set_font)R_GetCCallable("gdtools", "gdtools_font_context_set_font");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
            rcpp_result_gen = p_font_context_set_font(Rcpp::wrap(cc), Rcpp::wrap(family), Rcpp::wrap(fontsize), Rcpp::wrap(bold), Rcpp::wrap(italic));
        }
        if (rcpp_result_gen.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (rcpp_result_gen.inherits("try-error"))
    ...
    inline FontMetric font_context_extents(XPtrFamiliesContext cc, std::string x) {
        typedef SEXP(*Ptr_font_context_extents)(SEXP,SEXP);
        static Ptr_font_context_extents p_font_context_extents = NULL;
        if (p_font_context_extents == NULL) {
            validateSignature("FontMetric(*font_context_extents)(XPtrFamiliesContext,std::string)");
            p_font_context_extents = (Ptr_font_context_extents)R_GetCCallable("gdtools", "gdtools_font_context_extents");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
            rcpp_result_gen = p_font_context_extents(Rcpp::wrap(cc), Rcpp::wrap(x));
        }
        if (rcpp_result_gen.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (rcpp_result_gen.inherits("try-error"))
    ...
    inline std::string font_context_fontname(XPtrFamiliesContext cc) {
        typedef SEXP(*Ptr_font_context_fontname)(SEXP);
        static Ptr_font_context_fontname p_font_context_fontname = NULL;
        if (p_font_context_fontname == NULL) {
            validateSignature("std::string(*font_context_fontname)(XPtrFamiliesContext)");
            p_font_context_fontname = (Ptr_font_context_fontname)R_GetCCallable("gdtools", "gdtools_font_context_fontname");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
            rcpp_result_gen = p_font_context_fontname(Rcpp::wrap(cc));
        }
        if (rcpp_result_gen.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (rcpp_result_gen.inherits("try-error"))
