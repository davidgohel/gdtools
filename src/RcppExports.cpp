...
// context_set_font
void context_set_font(XPtrCairoContext cc, std::string fontname, double fontsize, bool bold, bool italic);
...
BEGIN_RCPP
    ...
    context_set_font(cc, fontname, fontsize, bold, italic);
    return R_NilValue;
END_RCPP_RETURN_ERROR
}
...
static int gdtools_RcppExport_validate(const char* sig) { 
    ...
    if (signatures.empty()) {
        ...
        signatures.insert("void(*context_set_font)(XPtrCairoContext,std::string,double,bool,bool)");
