...
| Register non-system fonts: Google Fonts or Liberation fonts (bundled) must be made visible to ‘systemfonts’                                 | [`register_gfont()`](https://davidgohel.github.io/gdtools/dev/reference/register_gfont.md), `register_liberation*()`, and the [`font_set()`](https://davidgohel.github.io/gdtools/dev/reference/font_set.md) wrapper |
| Embed fonts in HTML: Shiny, R Markdown and girafe need `htmlDependency` objects so the browser loads the right fonts                        | [`gfontHtmlDependency()`](https://davidgohel.github.io/gdtools/dev/reference/gfontHtmlDependency.md), `liberation*HtmlDependency()`, and `font_set()$dependencies`                                                   |
